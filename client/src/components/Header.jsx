                        ...
                        <nav className>
                            <div className=" flex flex-row justify-between">
                                <div className=" flex space-x-3 items-center py-5 lg:pl-7 sm:pl-6 py-6 pl-4 pr-8">
                                    ...
                                    <h1 className=" font-normal text-2xl leading-6 text-gray-800">ourSite</h1>
                                </div>
                                ...
                                <div className="lg:flex hidden flex-auto justify-between flex-row px-7 border-l border-r border-gray-200 py-6">
                                    <div className>
                                        <p className=" font-normal text-xs leading-3 text-gray-600">Hi {user.given_name}</p>
                                        <h3 className=" font-bold text-xl leading-5 text-gray-800 mt-2">Welcome Back</h3>
                                    </div>
                                    <div className>
                                    <button onClick={() => logout({ returnTo: window.location.origin })} className='bg-red-500 text-white px-6 py-2.5 font-semibold rounded focus:outline-none'>Logout</button>
                                    </div>
                                ...
                                <div className=" hidden sm:flex justify-end flex-row lg:pr-7 sm:pr-6 py-6 pr-4 pl-8">
                                    ...
                                    <div className=" flex justify-center items-center flex-row">
                                        <img className="w-10 h-10 " src={user.picture} alt="individual person image-3" />
                                        <div className="ml-2">
                                            <p className="text-lg leading-4 font-semibold text-gray-800">{user.name}</p>
