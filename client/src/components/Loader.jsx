    ...
    return (
        <div>
            <div class="flex flex-col justify-center items-center h-screen">
                ...
                {/* <h1 className="mx-auto p-4  max-w-4xl font-display text-4xl font-medium tracking-tight text-slate-900 sm:text-4xl">
                        ...
                        <span className="relative whitespace-nowrap text-blue-600">
                            ...
                            <span className="relative font-semibold animate-text bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">Login</span>
                        </span>{' '}
                        page
                    </h1> */}
            </div>
